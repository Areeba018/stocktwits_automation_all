...
class NamecheapApi(object):
    ...
    # def domains_dns_setEmailForwarding(self, domain, value):
    #     """Sets email forwarding for a domain.

    #     Example:

    #     api.domains_dns_setEmailForwarding('example.com', {
    #         'HostName' : '@',
    #         'RecordType' : 'URL',
    #         'Address' : 'http://news.ycombinator.com',
    #         'MXPref' : '10',
    ...
    #     extra_payload['SLD'] = sld
    #     extra_payload['TLD'] = tld
    #     self._call("namecheap.domains.dns.setEmailForwarding", extra_payload)
